...
- [MCPProxy - Open-source MCP gateway with BM25 tool discovery, quarantine-based security, Docker isolation, and OAuth 2.1 by smart-mcp-proxy](https://github.com/smart-mcp-proxy/mcpproxy-go)
